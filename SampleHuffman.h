 ...
 *
 * Modified 2020-01-11 by Roger Cheng with a "complete" method to know when playback is done.
 *
*/
...
public:
  ...
  /** Whether sample playback is complete.
  */
  inline
  boolean complete()
  {
    return (datapos >= sounddata_bits);
  }
